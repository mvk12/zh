...
vue__WEBPACK_IMPORTED_MODULE_7__.default.component("v-select", (vue_select__WEBPACK_IMPORTED_MODULE_4___default()));
vue__WEBPACK_IMPORTED_MODULE_7__.default.use((vue_toast_notification__WEBPACK_IMPORTED_MODULE_5___default()), {
  position: "top-right"
});
console.log("%c[" + new Date().toUTCString() + "]\nNoktos", "font-weight: bold; padding: 5px; font-size: 1.1em; background-color: #14b5e1; color: white;");
console.log("%cEnviroment: " + "development", "font-weight: bold; background-color: blue; color: white; padding: 5px");

if (true) {
  console.group("> Enviroment variables");
  console.table(({"NODE_ENV":"development","API_URL":"http://zh.test/api/"}));
  console.groupEnd();
}
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_0__.library.add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__.faAngleDown, _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__.faExclamationTriangle, _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__.faSpinner, _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__.faTimes);
vue__WEBPACK_IMPORTED_MODULE_3__.default.component("fai", _fortawesome_vue_fontawesome__WEBPACK_IMPORTED_MODULE_1__.FontAwesomeIcon);
...
var routes = [{
  ...
  component: function component() {
    return __webpack_require__.e(/*! import() | home */ "home").then(__webpack_require__.bind(__webpack_require__, /*! @/pages/Home/index.vue */ "./resources/js/pages/Home/index.vue"));
  },
  meta: {
    requiresAuth: false
  }
...
/***/ "./resources/js/services/common/login.js":
/*!***********************************************!*\
  !*** ./resources/js/services/common/login.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "oauthToken": () => (/* binding */ oauthToken)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);

var oauthToken = function oauthToken(formData) {
  return axios__WEBPACK_IMPORTED_MODULE_0___default()({
    url: "http://zh.test/api/" + "/oauth/token",
    method: "POST",
    headers: {
...
/***/ "./resources/js/services/common/user.js":
/*!**********************************************!*\
  !*** ./resources/js/services/common/user.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var fetchUserData = function fetchUserData() {
  return axios__WEBPACK_IMPORTED_MODULE_0___default()({
    url: "http://zh.test/api/" + "/api/user",
    method: "GET",
    headers: {
      Accept: "application/json",
      Authorization: "Bearer ".concat(_store__WEBPACK_IMPORTED_MODULE_1__.store.state.token)
    }
  }).then(function (_ref) {
    var data = _ref.data;
...
var isOnline = function isOnline() {
  return axios__WEBPACK_IMPORTED_MODULE_0___default()({
    url: "http://zh.test/api/" + "/api/common/online",
    method: "GET",
    headers: {
      Accept: "application/json",
      Authorization: "Bearer ".concat(_store__WEBPACK_IMPORTED_MODULE_1__.store.state.token)
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _services_common_login__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/services/common/login */ "./resources/js/services/common/login.js");
/* harmony import */ var _services_common_user__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/services/common/user */ "./resources/js/services/common/user.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mutations: {
    ...
    auth_ok: function auth_ok(state, _ref) {
      var access_token = _ref.access_token,
          refresh_token = _ref.refresh_token;
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.setValueOnLocalStorage)("nk_zh_token", access_token);
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.setValueOnLocalStorage)("nk_zh_refresh_token", refresh_token);
      state.token = access_token;
      state.refreshToken = refresh_token;
      state.isLoggedIn = true;
    },
    auth_error: function auth_error(state, _ref2) {
      var errorMsg = _ref2.errorMsg;
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.removeKeyFromLocalStorage)("token");
      state.errorMsg = errorMsg;
    },
    auth_complete: function auth_complete(state) {
      state.loading = false;
    },
    logout: function logout(state) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.removeKeyFromLocalStorage)("nk_zh_token");
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.removeKeyFromLocalStorage)("nk_zh_refresh_token");
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.removeKeyFromLocalStorage)("nk_zh_user");
      state.loading = false;
      state.errorMsg = null;
      state.token = null;
    ...
    user_data: function user_data(state, user) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.setValueOnLocalStorage)("nk_zh_user", JSON.stringify(_objectSpread({}, user)));
  ...
  actions: {
    login: function login(_ref3, payload) {
      ...
      return (0,_services_common_login__WEBPACK_IMPORTED_MODULE_0__.oauthToken)(formData).then(function (data) {
        ...
        return (0,_services_common_user__WEBPACK_IMPORTED_MODULE_1__.fetchUserData)();
      }).then(function (data) {
        commit("user_data", _objectSpread({}, data));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setValueOnLocalStorage": () => (/* binding */ setValueOnLocalStorage),
/* harmony export */   "removeKeyFromLocalStorage": () => (/* binding */ removeKeyFromLocalStorage)
/* harmony export */ });
var setValueOnLocalStorage = function setValueOnLocalStorage(key, value) {
  window.localStorage.setItem(key, value);
};
var removeKeyFromLocalStorage = function removeKeyFromLocalStorage(key) {
